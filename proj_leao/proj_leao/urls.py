...
from app_leao.views import home, form, conciliar, atualizar_status_json, provisao_periodo
...
urlpatterns = [
    ...
    path("provisao/", provisao_periodo, name="provisao"),  # Nova rota de provisão
